...
function Card1({ photo, title, text }: Props) {
  return (
    <div className='bg-white h-10/12 max-w-[500.001px] border rounded-2xl shadow-[6px_6px_0px_2px_#1E1E1E] relative py-15 px-10 col-span-2 mb-20 m-auto max-[1650]:col-span-3 max-[1130]:col-span-6'>
